...
*e.g. create baseline data, track progress against a policy, monitor provider performance*\
\
...
*e.g. MoE IT unit, regional coordinators*\
\
...
*e.g. Zoom webinar, WhatsApp group, hotline*\
\
...
*e.g. community of practice, standing review meeting, reinstallation protocol*
{% endhint %}
...
*e.g. MoE planning unit for ISP contract review, regional offices for school support prioritisation*\
\
**Access channels** — How will users access the data?\
*e.g. Giga Maps dashboard, API, exported reports*\
\
**Use case** — What specific decision or action will Giga Meter data inform?\
*See [Defining Your Use Case](../data/use-case-definition.md)*\
\
...
{% hint style="info" %}
**Short-term success** *(first 3 months)*\
